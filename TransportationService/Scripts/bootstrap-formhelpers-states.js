  ...
  BFHStates.prototype = {
    ...
    , loadBootstrapStates: function(country) {
      ...
      for (var state in BFHStatesList) {
        $options.append('<li><a tabindex="-1" href="#" data-option="' + state + '">' + BFHStatesList[state] + '</a></li>')
      }
      
      $toggle.data('option', value)
      if (typeof BFHStatesList[value] == "undefined") {
        $toggle.html('')
      } else {
        $toggle.html(BFHStatesList[value])
      }
    ...
    , displayState: function () {
      ...
      this.$element.html(BFHStatesList[value])
    }
